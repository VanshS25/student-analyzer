...
var ASM_CONSTS = {
  70808: ($0) => { localStorage.setItem('spa_data', UTF8ToString($0)); },  
 70864: () => { var s = localStorage.getItem('spa_data'); if (!s) return 0; var len = lengthBytesUTF8(s) + 1; var heap = _malloc(len); stringToUTF8(s, heap, len); return heap; }
};
